...
<body>
  ...
  <form method="post" action="./insertar_logica.php">
    <label id="cedula">Cédula: <input id="cedula" name="cedula" type="text" required /></label>
    ...
    <label id="direccion">Direccion: <textarea id="direccion" name="direccion" required rows="5"
